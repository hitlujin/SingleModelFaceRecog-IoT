...
# video = cv2.VideoCapture()
# if not video.open('/usr/local/aiivr/exppic/videofile/chenglong.mp4'):
...
def vidieo():
    ...
    status = data['status']
    # saveFileName = request.args['saveFileName']
    # uploadFileName = request.args['uploadFileName']
    # uploadTime = request.args['uploadTime']
    # uploadUserId = request.args['uploadUserId']
